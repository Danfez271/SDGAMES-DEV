...
<div class="font-Kanit bg-[#041333]">
    ...
    <div class="grid grid-cols-1 bg-[#041333] xl:pt-0 md:pt-12" id="catalog">
        <div class=" pt-2 text-center justify-center pr-14 pl-14 lg:mt-20 md:mt-20 xs:mt-10 ">
    ...
    <div class="sm:bg-[url(../../public/images/homepage/bannermission.png)] xs:bg-[url(../../public/images/homepage/movilrespon/bnncontactomovil.png)] xs:bg-cover bg-center bg-cover min-h-[700px]     sm:py-40 bg-no-repeat w-full  flex sm:justify-start sm:text-start sm:items-start xs:items-start  xs:text-center xs:pt-[30vw] lg:min-h-[500px] md:min-h-[400px] ">
        <h1 class=" text-white sm:mx-24 md:mb-12 md:mt-12 xs:mx-10 xmin:mx-20  ">
            ...
            <div class="flex justify-center sm:justify-start  px-1 py-6 sm:mx-0  hover:fill-[#02F2EB] ">
                <button class="sm:py-4   sm:px-6 xs:py-2 xs:px-2 gap-3 font-semibold sm:text-5xl xs:text-3xl flex  *:hover:fill-[#02F2EB]  justify-center items-center rounded-full bg-gradient-to-r from-[#A200FF] to-[#510080]  hover:text-[#02F2EB] hover:fill-[#02F2EB] hover:bg-gradient-to-r hover:from-white hover:to-white ">
